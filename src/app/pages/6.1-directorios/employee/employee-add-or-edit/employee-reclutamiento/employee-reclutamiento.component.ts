...
import SolicitudAltaComponent from 'src/app/pages/7.0-reclutamiento/solicitudes/solicitud-alta/solicitud-alta.component';
import SolicitudBajaComponent from 'src/app/pages/7.0-reclutamiento/solicitudes/solicitud-baja/solicitud-baja.component';
import SolicitudModificacionSalarioComponent from 'src/app/pages/7.0-reclutamiento/solicitudes/solicitud-modificacion-salario/solicitud-modificacion-salario.component';
